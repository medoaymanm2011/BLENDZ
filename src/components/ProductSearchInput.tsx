    ...
    <div className="w-full max-w-sm">
      <div className="relative">
        <input
          ...
          className="w-full pl-3 pr-9 py-2 rounded-xl border border-blue-500 bg-white placeholder:text-gray-400 text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200"
        />
