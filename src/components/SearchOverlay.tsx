...
export default function SearchOverlay({ open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[80]">
      ...
      {/* Centered panel */}
      <div className="relative h-full w-full flex items-start justify-center pt-24 px-4">
        <div className="w-full max-w-2xl">
          ...
          <div className="relative rounded-2xl border border-gray-200 bg-white shadow-lg">
            <input
              ...
              className="w-full h-14 rounded-2xl bg-transparent px-4 pr-14 text-gray-900 placeholder:text-gray-400 focus:outline-none"
            />
            <button
              onClick={goSearch}
              className="absolute top-1/2 -translate-y-1/2 right-3 inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#2F3E77] text-white hover:brightness-110 shadow"
